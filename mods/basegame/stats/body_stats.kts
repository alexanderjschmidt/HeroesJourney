...
relate(Ids.STAT_STAMINA, Relation.RESOURCE, Ids.STAT_STAMINA_REGEN)
relate(Ids.STAT_FOCUS, Relation.RESOURCE, Ids.STAT_FOCUS_REGEN)
relate(Ids.STAT_MANA, Relation.RESOURCE, Ids.STAT_MANA_REGEN)
relate(Ids.STAT_MOXIE, Relation.RESOURCE, Ids.STAT_MOXIE_REGEN)
