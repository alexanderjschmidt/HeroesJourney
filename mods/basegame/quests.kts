...
quest {
    ...
    cost { stat(Ids.STAT_STAMINA, 2) }
    rewards { stat(Ids.STAT_FOCUS, 1) }
    fameReward = 10
}.register()
...
quest {
    ...
    cost { stat(Ids.STAT_FOCUS, 1) }
    rewards { stat(Ids.STAT_MANA, 2) }
    fameReward = 25
}.register()
