...
public class EntityFactory {
    ...
    public void addPlayerComponents(UUID entityId) {
        ...
        entity.create(PossibleActionsComponent.class)
            ...
            .addAction(COMPLETE_QUEST)
            .addAction(QUEST_BOARD)
            .addAction(TRAINING)
            .addAction(WORKOUT_TRAINING)
            .addAction(STUDY_TRAINING)
            .addAction(PRACTICE_TRAINING)
            .addAction(SOCIALIZE_TRAINING)
            .addAction(Ids.APPROACH_FIGHT)
            .addAction(Ids.APPROACH_NEGOTIATE)
            .addAction(Ids.APPROACH_TRICK)
            .addAction(Ids.APPROACH_MAGIC_MISSILE);
