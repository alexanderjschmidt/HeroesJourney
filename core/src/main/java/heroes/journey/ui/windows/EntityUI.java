...
public class EntityUI extends UI {
    ...
    public EntityUI() {
        ...
        this.health = new ResourceBar(ResourceManager.get(ResourceManager.UI)[3][0], null);
        this.mana = new ResourceBar(ResourceManager.get(ResourceManager.UI)[2][1], null);
        this.stamina = new ResourceBar(ResourceManager.get(ResourceManager.UI)[3][1], null);
