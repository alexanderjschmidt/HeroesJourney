...
public class SplashScreen implements Screen {
    ...
    public void show() {
        ...
        bl.addAction(sequence(Actions.alpha(0), delay(.2f), fadeIn(1.5f, Interpolation.pow2), delay(1.3f),
            fadeOut(1f)));
        schmidt = new Image(ResourceManager.get().getTexture("Textures/splash/aschmidtlogo.png"));
        schmidt.setPosition(stage.getWidth() / 2 - (schmidt.getWidth() * 3 / 2),
            stage.getHeight() / 2 - schmidt.getHeight());
        schmidt.addAction(
            sequence(Actions.alpha(0), delay(.4f), fadeIn(1.5f, Interpolation.pow2), delay(1.1f), fadeOut(1f),
